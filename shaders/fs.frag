...
void main() {
  ...
  shape *= V(vec2(uv.x * scale, uv.y * scale + sS * 22.), time, fw);
  shape *= W(vec2(uv.x * scale, uv.y * scale + sS * 23.), time, fw);
  shape *= X(vec2(uv.x * scale, uv.y * scale + sS * 24.), time, fw);
  shape *= Y(vec2(uv.x * scale, uv.y * scale + sS * 25.), time, fw);
  shape *= Z(vec2(uv.x * scale, uv.y * scale + sS * 26.), time, fw);
